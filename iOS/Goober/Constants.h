...
#define kUberRedirectUrl            nil//@"https://GVHlANVgkCCANB6RdW8InlAMtU6FqG86EZC6gxel:javascript-key=tZr9rIEilQDb6od8Lyr8lYjqahRqhFZoC9114P68@api.parse.com/1/classes/HTTPResponse"
...
static double const kHSMaximumSearchDistance = 100.0;
static double const kHSMetersInAKilometer = 1000.0; // this is an exact value.

static NSUInteger const kHSSearch = 20; // query limit for pins and tableviewcells
